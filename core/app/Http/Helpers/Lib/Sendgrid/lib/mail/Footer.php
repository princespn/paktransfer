...
class Footer implements \JsonSerializable
{
    ...
    private $enable;
    /** @var $text string The plain text content of your section */
    private $text;
    /** @var $html string The HTML content of your section */
    private $html;
     ...
     * @param string|null $text The plain text content of your section
     * @param string|null $html The HTML content of your section
     */
     ...
     *
     * @param string $text The plain text content of your section
     * 
     * @throws TypeException
     */ 
     ...
     *
     * @param string $html The HTML content of your section
     * 
     * @throws TypeException
     */ 
