                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Details')">
                                    <a href="javascript:void(0)" class="btn btn--dark btn-sm approveBtn"
                                       data-info="{{ $details }}"
                                       data-id="{{ $data->id }}"
                                       data-amount="{{ showAmount($data->amount,$general->currency)}} {{ __($general->cur_text) }}"
                                       data-charge="{{ showAmount($data->charge,$general->currency)}} {{ __($general->cur_text) }}"
                                       data-after_charge="{{ showAmount($data->amount + $data->charge,$general->currency)}} {{ __($general->cur_text) }}"
                                       data-rate="{{ showAmount($data->rate,getCurrency($data->method_currency))}} {{ __($data->method_currency) }}"
