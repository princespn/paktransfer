...
<section class="account-section style--two">
    <div class="left">
      <div class="left-inner w-100">
        ...
        <form class="account-form mt-5" action="{{ route('agent.register') }}" method="POST" onsubmit="return submitUserForm();">
            @csrf
                <div class="row">
        ...
        <p class="font-size--14px text-center">@lang('Have an account?') <a href="{{route('agent.login')}}">@lang('Sign In Here').</a></p>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <a href="{{ route('agent.login') }}" class="btn btn--base btn-sm">@lang('Sign In')</a>
            </div>
      </div>
    </div>
</div>
