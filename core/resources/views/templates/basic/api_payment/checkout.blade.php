          ...
          <div class="checkout-wrapper rounded-3  {{@$apiPayment->checkout_theme   == 'dark' ? 'checkout-wrapper--dark':''}} shake-card">
              ...
              @else
                ...
                <div class="checkout-wrapper__header text-center">
                  ...
                  <h3 class="product-price mt-2">{{@$apiPayment->curr->currency_symbol}} {{showAmount($apiPayment->amount,$apiPayment->curr)}} {{@$apiPayment->curr->currency_code}}</h3>
                  <h6 class="mb-5 title fw-normal mt-2">@lang('for') {{__($apiPayment->details)}}</h6>
                </div>
                <form class="mt-5" class="check-mail">
                    @csrf
                  ...
                  <button type="button" class="btn btn-md btn--base w-100 next">@lang('Next')</button>
                </form>
