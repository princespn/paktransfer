...
<section class="account-section" >
  <div class="left">
    <div class="left-inner">
       ...
       <form class="account-form mt-5" method="POST" action="{{route('merchant.verify.sms')}}">
        @csrf
        <div class="form-group">
            <p class="text-center">@lang('Your Phone No.'):  <strong>{{merchant()->mobile}}</strong></p>
        </div>
      ...
      <div class="form-group">
        ...
        <small class="text-center"><a href="{{route('merchant.send.verify.code')}}?type=sms" class="forget-pass"> @lang('Resend code')</a></small>
