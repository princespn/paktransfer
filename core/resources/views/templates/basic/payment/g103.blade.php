                                        ...
                                        <form role="form" id="payment-form" method="{{$data->method}}" action="{{$data->url}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group-group ">
                                                        <input type="text" class="form-control form-control-lg " name="name" placeholder="@lang('Card Name')" autocomplete="off" autofocus/>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="tel" class="form-control form-control-lg input-sz" name="cardExpiry" placeholder="@lang('MM / YYYY')" autocomplete="off" required />
                                                </div>
                                                <div class="col-md-6 ">
