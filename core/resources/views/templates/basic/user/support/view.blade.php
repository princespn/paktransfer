                            ...
                            <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-between">
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn--success btn-round addFile">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <button type="submit" class="btn btn--success custom-success">
            ...
            $('.addFile').on('click',function(){
                $("#fileUploadsContainer").append(
                    `<div class="input-group mt-2">
                        ...
                        <span class="input-group-text btn btn--danger remove-btn">x</span>
