      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="account-wrapper">
            <div class="left bg_img" style="background-image: url('{{getImage('assets/images/frontend/login/'.@$content->background_image,'768x1200')}}');"></div>
            <div class="right">
              <div class="inner">
                <div class="text-center">
                  <h2 class="title">@lang('Verify Your Email')</h2>
                  <p class="font-size--14px mt-1">@lang('Enter the verification code that we\'ve sent in your email.')</p>
                </div>
                <form class="account-form mt-5" method="POST" action="{{route('user.verify.email')}}">
                  ...
                  <div class="form-group">
                    ...
                    <small class="text-center"><a href="{{route('user.send.verify.code')}}?type=email" class="forget-pass"> @lang('Resend code')</a></small>
