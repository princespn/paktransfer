...
@endphp
@section('content')
    <div class="row mb-5 gy-4 d-lg-flex">
        @foreach ($balanceWallets as $wallet)
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card custom--card border-10">
                    <div class="d-widget__content">
                        <h3 class="d-widget__amount fw-normal">{{$wallet->currency->currency_code}}={{showAmount($wallet->balance,$wallet->currency)}}</h3>
                    </div>
                </div><!-- d-widget end -->
            </div>
        @endforeach
