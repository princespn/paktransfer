                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($login_logs as $log)
                                ...
                                <td data-label="@lang('User')">
                                   ...
                                   @elseif($log->agent)
                                   <span class="small"> <a href="{{ route('admin.agent.detail', $log->agent_id) }}"><span>@</span>{{ @$log->agent->username }}</a> </span>
                                   @else
                                   <span class="small"> <a href="{{ route('admin.merchant.detail', $log->merchant_id) }}"><span>@</span>{{ @$log->merchant->username }}</a> </span>
                                   @endif
