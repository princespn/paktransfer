                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Rate')
                            <span class="font-weight-bold">
                                @if($deposit->wallet->currency_code == 'USD')
                                    1 USD = {{showAmount(1/$deposit->rate,$general->currency)}}{{__($deposit->baseCurrency())}}
                                @else
                                    1 {{__($deposit->baseCurrency())}}
                                    = {{ showAmount($deposit->rate,$general->currency) }} {{__($deposit->baseCurrency())}}
                                @endif
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Wallet Amount')
                            <span class="font-weight-bold">{{ showAmount($deposit->amount*$deposit->rate,$general->currency) }} {{__($deposit->wallet->currency_code)}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Status')
                            @if($deposit->status == 2)
