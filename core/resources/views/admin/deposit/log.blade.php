                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Amount')">
                                   {{ showAmount($deposit->amount,$general->currency ) }}{{ __($deposit->method_currency) }} + <span class="text-danger" data-toggle="tooltip" data-original-title="@lang('charge')">{{ showAmount($deposit->charge,$general->currency)}} </span>
                                    <br>
                                    <strong data-toggle="tooltip" data-original-title="@lang('Amount with charge')">
                                    {{ showAmount(($deposit->amount)*$deposit->rate,$general->currency) }} {{ __($deposit->wallet->currency_code) }}
                                    </strong>
                                </td>
