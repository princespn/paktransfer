            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('After Charge')
                            <span class="font-weight-bold">{{ showAmount($withdrawal->after_charge,$withdrawal->curr) }} {{ __($withdrawal->method_currency) }}</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="font-weight-bold">
                                ...
                                @if($withdrawal->wallet->currency_code != $withdrawal->currency)
                                    {{ showAmount($withdrawal->final_amount*$withdrawal->rate,$general->currency) }} {{__($withdrawal->wallet->method_currency)}}
                                @else
                                    {{ showAmount($withdrawal->final_amount,$general->currency) }} {{__($withdrawal->method_currency)}}
                                @endif
                            </span>
                        </li>
