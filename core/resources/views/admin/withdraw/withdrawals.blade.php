...
<div class="row justify-content-center">
    ...
    <div class="col-xl-4 col-sm-6 mb-30">
        <div class="widget-two box--shadow2 b-radius--5 bg--success">
            <div class="widget-two__content">
                <h2 class="text-white">{{ __($general->cur_sym) }}{{ showAmount($successful,$general->currency) }}</h2>
    ...
    <div class="col-xl-4 col-sm-6 mb-30">
        <div class="widget-two box--shadow2 b-radius--5 bg--pink">
            <div class="widget-two__content">
                <h2 class="text-white">{{ __($general->cur_sym) }}{{ showAmount($rejected,$general->currency) }}</h2>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Amount')">
                                   {{ showAmount($withdraw->amount,$general->currency) }} {{ __($withdraw->curr->currency_code) }} - <span class="text-danger" data-toggle="tooltip" data-original-title="@lang('charge')">{{ showAmount($withdraw->charge,$general->currency)}} </span>
                                    <br>
                                    <strong data-toggle="tooltip" data-original-title="@lang('Amount after charge')">
                                        @if($withdraw->wallet->currency_code != $withdraw->currency)
                                            {{ showAmount($withdraw->final_amount*$withdraw->rate,$general->currency) }} {{__($withdraw->wallet->currency_code)}}
                                        @else
                                            {{ showAmount($withdraw->final_amount,$general->currency) }} {{__($withdraw->currency)}}
                                        @endif
                                    </strong>
