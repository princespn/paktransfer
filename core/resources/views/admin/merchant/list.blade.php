                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td data-label="@lang('Merchant')">
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.merchant.detail', $user->id) }}"><span>@</span>{{ $user->username }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.merchant.detail', $user->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
