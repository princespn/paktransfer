                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold"> @lang('OTP Expiration') </label>
                                    <div class="input-group">
                                        <input class="form-control form-control-lg" type="text" name="otp_expiration" value="{{$general->otp_expiration}}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold">@lang('OTP Verification')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="otp_verification" @if($general->otp_verification) checked @endif>
                            </div>
                        </div>
                        <div class="row">
