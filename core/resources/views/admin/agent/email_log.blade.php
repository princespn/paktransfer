                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        <td data-label="@lang('User')">
                                            <span class="font-weight-bold">{{ @$log->agent->fullname }}</span>
                                                <br>
                                            <span class="small">
                                                <a href="{{ route('admin.agent.detail', $log->user_id) }}"><span>@</span>{{ $log->agent->username }}</a>
                                            </span>
                                        </td>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('admin.agent.email.details',$log->id) }}" class="icon-btn btn--primary" target="_blank"><i class="fas fa-desktop"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
