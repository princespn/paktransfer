                    ...
                    <ul class="list-group">
                        @forelse ($wallets->where('balance','>',0) as $wallet)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="font-weight-bold">{{showAmount($wallet->balance,$general->currency)}}  {{__($wallet->currency->currency_code)}}</span>
                            </li>
                        @empty
                    ...
                    <div class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                ...
                                <span class="amount">{{showAmount($totalDeposit,$general->currency)}}</span>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="currency-sign">{{__($general->cur_sym)}}</span>
                                <span class="amount">{{showAmount($totalWithdraw,$general->currency)}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="currency-sign">{{__($general->cur_sym)}}</span>
                                <span class="amount">{{showAmount(array_sum($totalMoneyIn),$general->currency)}}</span>
                            </div>
                            <div class="desciption">
