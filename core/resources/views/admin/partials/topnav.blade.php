                    ...
                    <a href="{{ route('admin.notification.read',$notification->id) }}" class="dropdown-menu__item">
                      <div class="navbar-notifi">
                        ...
                        <div class="navbar-notifi__left bg--green b-radius--rounded">
                          <img src="{{ getImage(imagePath()['profile'][strtolower($notification->user_type)]['path'].'/'.@$notification->user->image,imagePath()['profile'][strtolower($notification->user_type)]['size'])}}" alt="@lang('Profile Image')">
                        </div>
                        @else
                        <div class="navbar-notifi__left bg--green b-radius--rounded">
                          <img src="{{ getImage('/','350x300')}}" alt="@lang('Profile Image')">
                        </div>
                        @endif
                        <div class="navbar-notifi__right">
                          <h6 class="notifi__title">{{ __($notification->title) }} <small class="{{$class ?? ''}}">({{$notification->user_type ?? 'GUEST'}})</small></h6>              
